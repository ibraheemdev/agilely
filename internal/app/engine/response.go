...
//
// Engine controller methods (like the one called in response to
...
// both json and html) When an engine controller wants to redirect a user to
...
func (a *Engine) Email(ctx context.Context, email mailer.Email, ro EmailResponseOptions) error {
