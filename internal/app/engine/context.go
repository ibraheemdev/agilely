...
func (a *Engine) CurrentUserID(r *http.Request) (string, error) {
...
// any reason.
func (a *Engine) CurrentUserIDP(r *http.Request) string {
...
func (a *Engine) CurrentUser(r *http.Request) (User, error) {
...
// any reason.
func (a *Engine) CurrentUserP(r *http.Request) User {
...
func (a *Engine) LoadCurrentUserID(r **http.Request) (string, error) {
	pid, err := a.CurrentUserID(*r)
	if err != nil {
		return "", err
	}
...
func (a *Engine) LoadCurrentUserIDP(r **http.Request) string {
...
func (a *Engine) LoadCurrentUser(r **http.Request) (User, error) {
	if user := (*r).Context().Value(CTXKeyUser); user != nil {
		return user.(User), nil
	}
...
func (a *Engine) LoadCurrentUserP(r **http.Request) User {
